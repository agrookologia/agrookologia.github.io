...
### Körkörös és szolidáris gazdaság
   <a href="/images/Az-Agrookologia_tiz_alapelve.02.16-1.pdf" class="th right">
    <figure>
        <img src="/images/alapelv-kiadvany-thumbnail.png" max-width="300px">
        <figcaption>Kattints ide a kiadvány letöltéséhez</figcaption>
    </figure> </a>
